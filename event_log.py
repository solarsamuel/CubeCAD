...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        #layout.addWidget(self.opengl_grid)
    ...
    '''            
    def update_event_log(self, log_text):
        self.event_log_widget.setPlainText(log_text)
        self.event_log_widget.verticalScrollBar().setValue(self.event_log_widget.verticalScrollBar().maximum())
    '''
